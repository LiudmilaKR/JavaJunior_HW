...
// содержит ли наш класс аннотацию Table?
...
//                доступна ли в рамках поля аннотация Column?
        ...
        if (clazz.isAnnotationPresent(Table.class)) {
            ...
            for (Field field : fields) {
                if (field.isAnnotationPresent(Column.class)) {
                    ...
                    if (columnAnnotaion.primaryKey()) {
                        continue;
                    }
                    query.append(columnAnnotaion.name()).append(" = '").append(field.get(obj)).append("', ");
                }
            }
