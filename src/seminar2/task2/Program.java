...
public class Program {
     ...
     * их с таблицами и столбцами в базы данных.
     ...
     *   Реализуйте класс QueryBuilder, который может принимать объект и генерировать SQL-запросы
     *   для выполнения операций CRUD (Create, Read, Update, Delete) на основе аннотаций.
     ...
     * (DELETE FROM <Table> WHERE ID = '<id>') в классе QueryBuilder который мы разработали на семинаре.
     */
    public static void main(String[] args) throws IllegalAccessException {
        Employee user = new Employee("Stanislav", "sampl@gmail.com");
